...
function LoginPageContent() {
    ...
    return (
        <div className="relative min-h-screen w-full flex items-center justify-center overflow-hidden font-sans">
            ...
            {/* 1. Background - Wedding Photo + Light Overlay (Django Style) */}
            ...
            {/* 2. Glass Login Card (Django Style) */}
            <div className="relative z-10 w-full max-w-md px-6 animate-fade-in-up">
                <div className="rounded-3xl p-8 md:p-10 shadow-2xl bg-white/60 backdrop-blur-xl border border-white/50">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <h2 className="font-serif text-3xl font-bold text-gray-800 mb-2">Welcome Back</h2>
                        <p className="text-gray-500 text-sm font-medium">Plan your dream wedding with Wepln</p>
                    </div>

                    {/* Error Message */}
                    {errorParam && (
                        <div className="p-3 rounded-xl bg-red-100 border border-red-200 text-red-600 text-xs text-center font-medium mb-5">
                            아이디 또는 비밀번호를 확인해주세요.
                        </div>
                    )}
                    ...
                    <div className="space-y-3">
                        ...
                        {/* Naver Button - 일시 비활성화 */}
                        {/* <button
                            onClick={() => handleSocialLogin('naver')}
                            disabled={loading}
                            className="w-full py-4 rounded-xl bg-[#03C75A] hover:bg-[#02b351] flex items-center justify-center gap-3 text-white font-bold shadow-lg shadow-[#03C75A]/30 hover:-translate-y-0.5 transition-all"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full py-4 rounded-xl bg-[#FEE500] hover:bg-[#fdd800] flex items-center justify-center gap-3 text-[#191919] font-bold shadow-lg shadow-[#FEE500]/30 hover:-translate-y-0.5 transition-all"
                        >
                        ...
                        <button
                            ...
                            disabled={loading}
                            className="w-full py-4 rounded-xl bg-white border border-gray-200 hover:bg-gray-50 flex items-center justify-center gap-3 text-gray-700 font-bold shadow-lg shadow-gray-200/50 hover:-translate-y-0.5 transition-all"
                        >
            ...
            {/* 3. Decorative Quote (Django Style) */}
            <div className="absolute bottom-10 left-0 w-full text-center text-white/90 text-xs font-serif italic z-10 drop-shadow-md">
