        ...
        >
            ...
            <div className="relative z-10 w-full max-w-5xl mx-auto px-5 py-12 flex flex-col lg:flex-row items-center gap-10 lg:gap-20">
                ...
                <div className="hidden lg:flex flex-col flex-1 text-left">
                    ...
                    <h1 className="text-4xl xl:text-5xl font-bold text-white mb-5 tracking-tight leading-[1.18]">
                        결혼 준비의<br />
                    ...
                    <div className="space-y-3.5">
                        {[
                            ...
                            <div key={i} className="flex items-center gap-3">
                                ...
                                <span className="text-white/52 text-sm">{label}</span>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="w-full max-w-md lg:max-w-[360px] xl:max-w-md flex-shrink-0">
