...
import { Sparkles, Plus, Trash2, CheckCircle2, Circle, ExternalLink, Loader2 } from 'lucide-react'
        ...
        <div className="max-w-4xl mx-auto px-4 pb-20 space-y-6">
                ...
                >
                    <div className="flex items-center gap-2 mb-5">
                        ...
                        <span className="text-xs text-gray-400 ml-auto">클릭하면 업체 검색으로 이동</span>
                    </div>
